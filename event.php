...
if($result = mysqli_query($link, $sql)){
    ...
    <div class="w3-row w3-padding-64" id="about">
        ...
        <div class="w3-col m6 w3-padding-large"  border="thin solid black">
          <h1 class="w3-center"><u><?php echo $title;?></u></h1><br>
          <h5 class="w3-medium w3-center">Tipul evenimentului: <?php echo $type;?></h5><br>
          <p class="w3-large">Descriere:   <?php echo $description; ?></p><br>
          <p class="w3-large">Locatia: <?php echo $location;?></p><br>
          <p class="w3-large">Data evenimentului: <?php echo $date;?></p><br>
          <p class="w3-large">Numar de telefon: <?php echo $phone;?></p><br>
          <br><br><br>
              <?php
  ...
  echo"Acest eveniment nu exista.";
}
?>
<?php
  if(isset($_SESSION['username'])){
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                <div  class="row" align="left">
                  <div  id="comment" class="col-md-6 col-md-offset-1">
                    <div class="panel panel-info">
                      <header><b><?php echo $username;?></b> - <span><?php echo $date?></span></header><br>
