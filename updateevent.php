...
<html>
<head>
<title>Actualizare eveniment</title>
...
<?php
    session_start();
    if($_SESSION['username'] != "admin" && !(isset($_SESSION['idevent']))){
...
<center>
    <div class="wrapper">
        <h2>Actualizeaza evenimentul</h2>
        <form action="update.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" name="date" value="<?php echo date('Y-m-d\TH:i:s', strtotime($date));?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="imagepath" required value="<?php echo $image;?>">
            </div>
            <div class="form-group">
                <input type="submit" name="submit" class="w3-button" value="Actualizeaza eveniment">
            </div>
        </form>
    </div>    
</center>
